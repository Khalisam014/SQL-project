...
CREATE TABLE RESERVATIONS_khalisam(
  unique_id INT PRIMARY KEY NOT NULL,
  paid INT,
  username VARCHAR(20) REFERENCES USERS_khalisam,
  flight_one INT REFERENCES FLIGHTS NOT NULL,
  flight_two INT REFERENCES FLIGHTS
);
